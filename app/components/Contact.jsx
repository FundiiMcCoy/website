...
const Contact = () => {
  ...
  //     emailjs
  //       .sendForm('service_f3ai8hx', 'template_ap6lrq9', form.current, {
  //         publicKey: '0BidZjWZWP9CcutVV',
  //       })
  //       .then(
  //         () => {
  //           console.log('SUCCESS!');
  ...
  return (
    <section
      id="contact" className="grid md:grid-cols-2 my-12 md:my-12 px-4 py-12 gap-4 relative">
      ...
      <div>
        ...
        <form className='flex flex-col'>
          ...
          <button type='submit' href='mailto:fundilemcoyi@gmail.com'
